 ...
 */
enum class NiveauExperience(val libelle: String, val facteur: Float) {
    DEBUTANT(libelle= "Débutant", facteur = 1.2F),       // Moins de 6 mois de course régulière
    INTERMEDIAIRE( libelle = "Intermédiaire", facteur = 1.55F),  // Entre 6 mois et 2 ans, a déjà couru des 10km ou semi-marathons
    AVANCE( libelle = "Avancé", facteur = 1.9F)         // Plus de 2 ans, plusieurs marathons à son actif
}
